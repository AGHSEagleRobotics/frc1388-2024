...
public class RobotContainer {
  ...
  private final DriveTrainSubsystem m_driveTrain = new DriveTrainSubsystem(
      ...
      new AHRS(AHRS.NavXComType.kUSB1), // navx
      m_limelight
  );
  ...
  private final IntakeSubsystem m_intakeSubsystem = new IntakeSubsystem(
      new SparkMax(IntakeConstants.ROLLER_MOTOR_CANID, MotorType.kBrushless),
      new SparkMax(IntakeConstants.LIFTER_MOTOR_CANID, MotorType.kBrushless),
  ...
  private final TransitionSubsystem m_transitionSubsystem = new TransitionSubsystem(
    new SparkMax(TransitionConstants.TRANSITION_MOTOR_CANID, MotorType.kBrushless),
    new DigitalInput(4)
  );
  ...
  public RobotContainer() {
    ...
    if (option8) {
      m_shooterSubsystem = new ShooterSubsystem(
          new SparkFlex(ShooterConstants.BOTTOM_SHOOTER_MOTOR_CANID,
              MotorType.kBrushless),
          new SparkFlex(ShooterConstants.TOP_SHOOTER_MOTOR_CANID,
              MotorType.kBrushless));

      m_shooterAngleSubsystem = new ShooterAngleSubsystem(
          new SparkMax(ShooterAngleSubsystemConstants.kShooterAngleMotorCANID, MotorType.kBrushed),
