...
public class SwerveModule {
    ...
    public SwerveModule(TalonFX driveMotor, TalonFX rotationMotor, CANcoder cancoder, double encoderOffset) {
        ...
        MotorOutputConfigs rotationOutputConfigs = new MotorOutputConfigs();
        rotationOutputConfigs.Inverted = InvertedValue.Clockwise_Positive;
        m_rotationMotor.getConfigurator().apply(rotationOutputConfigs);
