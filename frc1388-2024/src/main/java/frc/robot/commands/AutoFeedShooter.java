...
public class AutoFeedShooter extends Command {
  TransitionSubsystem m_transitionSubsystem;
  IntakeSubsystem m_intakeSubsystem;

  /** Creates a new AutoFeedShooter. */
  public AutoFeedShooter(TransitionSubsystem transitionSubsystem, IntakeSubsystem intakeSubsystem) {
  ...
  public boolean isFinished() {
    return !m_transitionSubsystem.isNoteDetected();
  }
}
